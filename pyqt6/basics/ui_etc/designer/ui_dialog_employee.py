...
class Ui_Dialog_Employee(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(466, 469)
        ...
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Help|QtWidgets.QDialogButtonBox.StandardButton.No|QtWidgets.QDialogButtonBox.StandardButton.Yes)
        self.buttonBox.setObjectName("buttonBox")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.buttonBox)
        self.pushButton = QtWidgets.QPushButton(parent=Dialog)
        self.pushButton.setObjectName("pushButton")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.pushButton)
        ...
        self.pushButton.clicked.connect(self.doubleSpinBox.clear) # type: ignore
        self.pushButton.clicked.connect(self.comboBox_2.clear) # type: ignore
        self.pushButton.clicked.connect(self.comboBox.clear) # type: ignore
        self.pushButton.clicked.connect(self.dateEdit.clear) # type: ignore
    ...
    def retranslateUi(self, Dialog):
        ...
        self.dateEdit.setDisplayFormat(_translate("Dialog", "d/mm/yy"))
        self.label_3.setText(_translate("Dialog", "Depart&ment :"))
        self.label_4.setText(_translate("Dialog", "&Position : "))
        self.label_5.setText(_translate("Dialog", "&Annual salary : "))
        self.label_6.setText(_translate("Dialog", "De&scription : "))
